...
export default function AvatarBuilder({ onClose, onSave }: AvatarBuilderProps) {
  ...
  const hairFilters = [
    "",
    "hue-rotate(-28deg) saturate(59%) brightness(30%)",
    "hue-rotate(-11deg) saturate(200%) brightness(61%)",
    "hue-rotate(-60deg) saturate(100%) brightness(102%)",
    "hue-rotate(+100deg) saturate(0%) brightness(103%)",
  ];
            ...
            <img
              ...
              style={{
                filter:
                  skinTone === null
                    ? ""
                    : skinFilters[skinOptions.indexOf(skinTone)],
              }}
            />
            ...
            <img
              ...
              style={{
                filter:
                  eyeColor === null
                    ? ""
                    : eyeFilters[eyeOptions.indexOf(eyeColor)],
              }}
            />
            <img
              src="/avatar/hair.png"
              ...
              style={{
                filter:
                  hairColor === null
                    ? ""
                    : hairFilters[hairOptions.indexOf(hairColor)],
              }}
            />
          </div>
        </div>
              ...
              {skinOptions.map((color, idx) => (
                <div
                  ...
                  className={`w-8 h-8 rounded cursor-pointer border-2 ${
                    skinTone === color ? "border-black" : "border-gray-300"
                  }`}
            ...
            <div className="flex gap-2">
              {eyeOptions.map((color, idx) => (
                <div
                  key={idx}
                  className={`w-8 h-8 rounded cursor-pointer border-2 ${
                    eyeColor === color ? "border-black" : "border-gray-300"
                  }`}
            ...
            <div className="flex gap-2">
              {hairOptions.map((color, idx) => (
                <div
                  key={idx}
                  className={`w-8 h-8 rounded cursor-pointer border-2 ${
                    hairColor === color ? "border-black" : "border-gray-300"
                  }`}
