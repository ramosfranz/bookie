...
export default function FriendInfoPopup({
  ...
  <div className="bg-white rounded-lg w-[420px] p-6 shadow-xl relative">
    ...
    <div className="mb-4 flex items-center gap-3">
      ...
      <div>
        <h2 className="text-xl font-bold text-orange-700">{friend.name}</h2>
    ...
    <div className="flex border-b mb-4">
      <button
        className={`flex-1 py-2 text-center ${
          activeTab === "profile"
            ? "border-b-2 border-orange-500 text-orange-700 font-semibold"
            : "text-gray-500"
        }`}
    ...
    {activeTab === "profile" && (
      <div>
        ...
        <button onClick={() => onUpdateNicknameOrGroupName(name)} className="pixelButton">
