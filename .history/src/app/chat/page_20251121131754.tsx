...
export default function ChatPage() {
  ...
  const [contacts, setContacts] = useState<Contact[]>([
    {
      ...
      avatar: "👥",
      messages: [
        { id: "1", sender: "other", senderName: "Alice", avatar: "👩", content: "Hey! How’s your research going?", timestamp: "10:00 AM" },
        { id: "2", sender: "other", senderName: "Bob", avatar: "👨", content: "I just found a new AI paper!", timestamp: "10:05 AM" },
        { id: "3", sender: "user", senderName: user.username, avatar: user.avatar, content: "Sounds interesting!", timestamp: "10:06 AM" },
      ],
    },
    {
      id: "c2",
      ...
      avatar: "👩",
      messages: [
        { id: "4", sender: "other", senderName: "Alice", avatar: "👩", content: "Hello there!", timestamp: "09:30 AM" },
      ],
    },
  ]);
  ...
  const sendMessage = (text: string) => {
    ...
    // Simulate other participants replying
    setTimeout(() => {
