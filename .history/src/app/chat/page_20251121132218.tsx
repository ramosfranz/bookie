...
<div className="flex items-center justify-between mb-4">
  ...
  friend={{
    ...friendProfile,
    isGroup: false, // or true if it's a group
    members: [
      { id: "c1", name: "Alice", avatar: "👩" },
      { id: "c2", name: "Bob", avatar: "👨" },
    ], // only if it's a group
  }}
  onUpdateNicknameOrGroupName={(newName: string) => console.log("Name updated:", newName)}
  onUnfriendOrLeaveGroup={() => console.log("Unfriend or leave group clicked")}
/>
