...
export default function ChatPage() {
  ...
  const [showAvatar, setShowAvatar] = useState(false); // Avatar placeholder toggle

  const chatEndRef = useRef<HTMLDivElement | null>(null);
  const selectedContact = contacts.find((c) => c.id === selectedContactId)!;

  // Dummy friend profile for FriendInfoPopup
  const friendProfile = {
              ...
              {contacts.map((contact) => (
                <button
                  ...
                  onClick={(e) => {
                    ...
                    setShowAvatar(false); // reset avatar toggle
                  }}
