...
// ⭐ NEW — Avatar placeholder component (inline)
function AvatarPlaceholder() {
  return (
    <div className="flex flex-col items-center gap-2 mb-4">
      <div className="w-20 h-20 bg-purple-300 rounded-full flex items-center justify-center text-3xl font-bold text-white shadow-md">
        📚
      </div>
              ...
              {contacts.map((contact) => (
                <button
                  ...
                  onClick={(e) => {
                    ...
                    setShowAvatar(false); // ⭐ NEW: Reset when switching contacts
                  }}
