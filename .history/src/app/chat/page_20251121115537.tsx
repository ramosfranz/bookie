...
import FriendInfoPopup from "./FriendInfoPopup"; // ✅ IMPORT THE INFO POPUP
...
export default function ChatPage() {
  ...
  // Dummy friend info for popup
  const friendProfile = {
    id: selectedContact.id,
    name: selectedContact.name,
    nickname: selectedContact.name, // Default nickname same as name
        ...
        <div className="flex-1 flex flex-col p-6">
          ...
          <div className="flex items-center justify-between mb-6 w-full">
            ...
            <div className="flex items-center gap-4 text-2xl ml-auto">
              <button className="hover:text-purple-600 transition" title="Study Mode">
                📘
              </button>

              <button
                onClick={() => setShowInfoPopup(true)} // ✅ OPEN INFO POPUP
