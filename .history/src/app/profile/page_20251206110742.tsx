              ...
              <div className="mt-2">
                ...
                <div className="flex gap-1 overflow-x-auto pb-1">
                  {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div
                      key={i}
                      className="w-27 h-20 flex-shrink-0 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300 hover:border-[#f67129] transition cursor-pointer"
                    >
