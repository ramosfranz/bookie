...
export default function AvatarBuilder({ onClose, onSave }: AvatarBuilderProps) {
  ...
  const eyeFilters = [
    "", // default
    "hue-rotate(0deg) saturate(-100%) brightness(100%)",     // 2nd
    "hue-rotate(102deg) saturate(0%) brightness(100%)",      // 3rd
    "hue-rotate(166deg) saturate(0%) brightness(100%)",      // 4th
    "hue-rotate(94deg) saturate(0%) brightness(100%)"        // 5th
  ];

  // Hair options
  const hairOptions = [null, "#c13037", "#6b4f2c", "#000000", "#ffffff"];
  const hairBoxColors = ["#ebba5e", "#c13037", "#6b4f2c", "#000000", "#ffffff"];
  const hairFilters = [
    "", // default
    "hue-rotate(-200deg) saturate(100%) brightness(60%)", // 2nd
    "hue-rotate(-11deg) saturate(200%) brightness(41%)", // 3rd
    "hue-rotate(+11deg) saturate(-100%) brightness(52%)",  // 4th
    "hue-rotate(-44deg) saturate(129%) brightness(123%)" // 5th
  ];
