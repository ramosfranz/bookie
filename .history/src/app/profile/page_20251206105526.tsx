    ...
    <div className="min-h-screen flex bookieBackground">
      ...
      <main className="flex-1 p-6 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-3xl">
          <h1 className="text-3xl font-bold mb-6 text-center" style={{ color: "#f67129" }}>
            My Profile
          </h1>
          ...
          <div className="border-2 border-gray-200 rounded-lg p-6 mb-6">
            <div className="flex gap-6 mb-6">
              ...
              <div className="relative flex-shrink-0">
                <div className="w-32 h-32 rounded-lg overflow-hidden bg-purple-200 relative image-rendering-pixelated border-2 border-gray-300">
                  <img
                    src="/avatar/skin.png"
                    alt="Avatar skin"
              ...
              <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    {isEditingUsername ? (
                      <>
                        ...
                        />
                        <button className="text-green-600 hover:text-green-700" onClick={saveUsername}>
                          <Check size={20} />
                        </button>
                        <button
                ...
                {/* LEVEL */}
                <div className="mb-3">
                  <label className="text-xs text-gray-500 uppercase font-semibold">Level</label>
                  <p className="text-lg font-semibold text-[#f67129]">Level {user.level || 1}</p>
                </div>
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                <label className="text-xs text-gray-500 uppercase font-semibold">Biography</label>
                {!isEditingBio && (
                  <button
                    className="text-gray-600 hover:text-[#f67129]"
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="aspect-[2/3] bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300 hover:border-[#f67129] transition cursor-pointer"
                  >
