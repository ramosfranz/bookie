      ...
      <main className="flex-1 p-6">
        ...
        <div className="bg-white rounded-xl shadow p-6 max-w-md relative">
          ...
          <div className="relative flex flex-col items-center gap-4">
            <div className="relative">
              <div className="w-24 h-24 rounded-full overflow-hidden bg-purple-200 relative image-rendering-pixelated">
                ...
                <img src="/avatar/skin.png" className="absolute inset-0 w-full h-full" style={{ filter: user.skinTone || "" }} />
                <img src="/avatar/fit.png" className="absolute inset-0 w-full h-full" />
                <img src="/avatar/eyes.png" className="absolute inset-0 w-full h-full" style={{ filter: user.eyeColor || "" }} />
                <img src="/avatar/hair.png" className="absolute inset-0 w-full h-full" style={{ filter: user.hairColor || "" }} />
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button onClick={() => supabase.auth.signOut()} className="pixelButton">
              Log Out
            </button>
          </div>
        </div>
