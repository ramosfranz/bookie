...
export default function DiscoverPage() {
  ...
  const [recommended] = useState([
    { id: 1, title: "Modern Web Security", url: "https://example.com/book1" },
    { id: 2, title: "AI & Society", url: "https://example.com/book2" },
    { id: 3, title: "Next.js Patterns", url: "https://example.com/book3" },
  ]);
