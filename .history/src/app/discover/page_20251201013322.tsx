...
export default function DiscoverPage() {
  ...
  const addToLibrary = (book: Book) => {
    ...
    // TODO: connect to Supabase or localStorage
  };
      ...
      <main className="flex-1 p-6">
        ...
        <div className="mt-8 p-4 bg-white rounded-lg shadow text-sm text-gray-600">
          ...
          <ul className="space-y-1 text-xs">
            <li>• Fiction: Classic books from Project Gutenberg, Open Library archives, and modern books from Google Books</li>
            <li>• Academic: Research papers from arXiv.org (AI, CS, Math) plus academic books from Gutenberg & Open Library</li>
            <li>• No Login Required: All content opens directly in your built-in reader/viewer.</li>
            <li>• Sources: PG = Project Gutenberg | OL = Open Library | GB = Google Books | arXiv = arXiv.org</li>
          </ul>
        </div>
      </main>
