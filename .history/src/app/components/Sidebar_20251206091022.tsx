  ...
  return (
    ...
    >
      ...
      <Link href="/profile" onClick={handleLinkClick} className="mb-8 flex flex-col items-center">
        ...
        {!isCollapsed && <p className="mt-3 font-semibold text-orange-700">{username}</p>}
      </Link>
      ...
      <nav className="flex flex-col items-center gap-6 mt-4">
        ...
        <Link
          ...
          onClick={handleLinkClick}
          className={`flex flex-col items-center text-xl ${
            activeTab === "discover" ? "text-orange-600" : "text-gray-500 hover:text-gray-700"
          }`}
        >
        ...
        <Link
          ...
          onClick={handleLinkClick}
          className={`flex flex-col items-center text-xl ${
            activeTab === "chat" ? "text-orange-600" : "text-gray-500 hover:text-gray-700"
          }`}
        >
      ...
      <button onClick={(e) => e.stopPropagation()} className="text-gray-500 hover:text-gray-700 text-3xl mb-4">
        ⚙️
      </button>
    </aside>
  );
