...
export default function Dashboard() {
  ...
  // Grid/List toggle for Leisure Library
  ...
  return (
    <div className="min-h-screen p-6 bg-indigo-50">
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`px-3 py-1 rounded ${
              viewMode === "list" ? "bg-purple-600 text-white" : "bg-white"
            }`}
          >
            List View
          </button>
          <button
            ...
            className={`px-3 py-1 rounded ${
              viewMode === "grid" ? "bg-purple-600 text-white" : "bg-white"
            }`}
          >
            Grid View
          </button>
      ...
      {/* Library List / Grid */}
      {activeTab === "research" || viewMode === "list" ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {currentLibrary.map((item) => (
            ...
            >
              {/* Book Icon */}
              <div className="w-12 h-16 bg-purple-200 rounded-md mb-2 flex items-center justify-center">
                📚
              </div>
